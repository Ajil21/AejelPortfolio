...
const Contact = () => {
    return (
        <section className="container" style={{ padding: '150px 20px', textAlign: 'center', marginBottom: '50px' }}>
            <motion.div
            ...
            <footer style={{ marginTop: '100px', color: '#444', fontSize: '1rem' }}>
                <p>Designed & Built by Aejel Varghese Babu</p>
            </footer>
        </section>
    );
};
